const translations = {
  'zh-TW': {
    ...
    'feature-3-title': '話題靈感庫，告別無話可說的尷尬',
    'feature-3-desc': '太久沒聯絡不知道聊什麼？別擔心，豐富的話題靈感庫提供各種破冰話題（例如小時候的趣事、家庭傳統），幫助你輕鬆開口，深入了解家人的內心世界。',

    'feature-4-title': '記錄互動點滴與重要紀念日',
    'feature-4-desc': '除了記錄通話與碰面，還能寫下筆記。並設定結婚紀念日、退休紀念日或健康檢查等重要日子，KinCue 會提前提醒，讓你絕不漏接每一個重要時刻。',

    'feature-5-title': '專屬回憶相簿，一鍵生成影片',
    'feature-5-desc': '把照片與值得珍藏的時刻整理在一起。只要選取照片、挑選喜歡的主題（如溫暖、歡聚）與配樂，就能一鍵產生精美的回憶小短片，隨時重溫美好。',
    ...
    'comp-cat-3': '聯絡提醒',
    'comp-item-3-1': '基本聯絡週期提醒',
    'comp-item-3-2': '提前溫馨提醒',
    'comp-item-3-3': '自訂提醒日期與時段',
    'comp-item-3-4': '生日提前 7 天提醒',
    'comp-item-3-5': '自訂重要事件提醒',
    'comp-item-3-6': '聯絡後續追蹤提醒',

    'comp-cat-4': '關係資訊',
    'comp-item-4-1': '基本聊天話題提示',
    'comp-item-4-2': '記錄對方喜好',
    'comp-item-4-3': '保存送禮靈感',
    'comp-item-4-4': '建立自訂重要日',
    'comp-item-4-5': '自訂聊天話題',

    'comp-cat-5': '年度回顧',
    'comp-item-5-1': '基本年度互動摘要',
    'comp-item-5-2': '每月互動趨勢',
    'comp-item-5-3': '聯絡方式分析',
    'comp-item-5-4': '年度精彩時刻',
    'comp-item-5-5': '年度互動時間軸',
    'comp-item-5-6': '跨年度比較',
    'comp-item-5-7': '分享年度回顧',

    'comp-cat-6': '回憶功能',
    'comp-item-6-1': '建立照片回憶',
    'comp-item-6-2': '製作回憶影片',
    'comp-item-6-3': '儲存回憶影片',
    'comp-item-6-4': '分享回憶影片',
  ...
  'en': {
    ...
    'feature-3-title': 'Topic Inspiration, Say Goodbye to Awkward Silences',
    'feature-3-desc': 'Don\'t know what to talk about? Don\'t worry. The rich topic inspiration library provides various icebreakers (like childhood fun, family traditions) to help you easily open up and deeply understand your family.',

    'feature-4-title': 'Log Interactions and Important Anniversaries',
    'feature-4-desc': 'Record calls, meetups, and add notes. Set up weddings, retirements, or health checkups, and KinCue will gently remind you in advance so you never miss an important moment.',

    'feature-5-title': 'Exclusive Memory Albums, Generate Videos in One Click',
    'feature-5-desc': 'Organize your photos and precious moments together. Just select photos, choose a theme (like warm, joyful), and background music to instantly generate a beautiful memory video to relive the good times.',
    ...
    'comp-cat-3': 'Reminders',
    'comp-item-3-1': 'Basic cycle reminders',
    'comp-item-3-2': 'Early gentle reminders',
    'comp-item-3-3': 'Custom reminder dates & times',
    'comp-item-3-4': 'Birthday 7-day early reminder',
    'comp-item-3-5': 'Custom event reminders',
    'comp-item-3-6': 'Follow-up reminders',

    'comp-cat-4': 'Relationship Info',
    'comp-item-4-1': 'Basic topic prompts',
    'comp-item-4-2': 'Record preferences',
    'comp-item-4-3': 'Save gift inspirations',
    'comp-item-4-4': 'Create custom important dates',
    'comp-item-4-5': 'Custom conversation topics',

    'comp-cat-5': 'Year in Review',
    'comp-item-5-1': 'Basic annual summary',
    'comp-item-5-2': 'Monthly interaction trends',
    'comp-item-5-3': 'Contact method analysis',
    'comp-item-5-4': 'Annual highlights',
    'comp-item-5-5': 'Annual interaction timeline',
    'comp-item-5-6': 'Cross-year comparisons',
    'comp-item-5-7': 'Share Year in Review',

    'comp-cat-6': 'Memories',
    'comp-item-6-1': 'Create photo memories',
    'comp-item-6-2': 'Create memory videos',
    'comp-item-6-3': 'Save memory videos',
    'comp-item-6-4': 'Share memory videos',
...
class I18n {
  ...
  updateImages() {
    const images = {
      'img-hero-dashboard': '01_Dashboard',
      'img-feature-dashboard': 'feature_dashboard',
      'img-feature-preferences': 'feature_preferences',
      'img-feature-topics': 'feature_topics',
      'img-feature-anniversaries': 'feature_anniversaries',
      'img-feature-memories': 'feature_memories',
      'img-feature-settings': 'feature_settings'
    };
